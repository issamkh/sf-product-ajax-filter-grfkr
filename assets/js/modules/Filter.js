...
export  default class Filter {
    ...
    bindEvents(){
        ...
        if(this.moreNav){
            ...
            this.pagination.addEventListener('click' , eventList)
    ...
    flipContent(content, append ){
        const springEffect = "gentle"
        const springExit = function (element,index, onComplete) {
            spring({
                config: "stiff",
        ...
        const springAppear = function (element,index) {
            spring({
                config: "stiff",
                values: {
                    translateY: [20, 0],
